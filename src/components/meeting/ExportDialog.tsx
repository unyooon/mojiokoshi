...
export function ExportDialog({ open, onClose, sessionId }: ExportDialogProps) {
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 m-auto backdrop:bg-black/50 rounded-lg p-0 w-full max-w-2xl max-h-[80vh] bg-background text-foreground border border-border shadow-lg"
    >
